...
class VAS_Diag {
	...
	onLoad = "['guns'] execVM 'INS_revive\gear\switch.sqf'";
	onUnload = "private '_loadout'; _loadout = [player] call INS_REV_FNCT_get_loadout; INS_REV_GVAR_player_loadout = _loadout;";
	...
	class controls {
		...
		class vasGear : VAS_RscListBox 
		{
			...
			text = "";
			sizeEx = 0.030;
			onLBSelChanged = "[] execVM 'INS_revive\gear\info.sqf'";
		...
		class vasPGear : VAS_RscListBox 
		{
			...
			text = "";
			sizeEx = 0.030;
			onLBSelChanged = "[2502] execVM 'INS_revive\gear\selection.sqf'";
		...
		class WeaponsBtn : VAS_RscButtonMenu
		{
			...
			text = "Weapons";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "['guns'] execVM 'INS_revive\gear\switch.sqf'";
			x = 0.42; y = 0.35;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class MagazinesBtn : VAS_RscButtonMenu
		{
			...
			text = "Magazines";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "['mags'] execVM 'INS_revive\gear\switch.sqf'";
			x = 0.42; y = 0.40;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class ItemsBtn : VAS_RscButtonMenu
		{
			...
			text = "Items";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "['items'] execVM 'INS_revive\gear\switch.sqf'";
			x = 0.42; y = 0.45;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class BackpacksBtn : VAS_RscButtonMenu
		{
			...
			text = "Backpacks";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "['packs'] execVM 'INS_revive\gear\switch.sqf'";
			x = 0.42; y = 0.50;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class GogglesBtn : VAS_RscButtonMenu
		{
			...
			text = "Goggles";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "['glass'] execVM 'INS_revive\gear\switch.sqf'";
			x = 0.42; y = 0.55;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		...
		class Title : VAS_RscTitle {
			colorBackground[] = {0, 0, 0, 0};
			idc = -1;
			text = "Virtual Ammobox System 0.9 (modified by naong)";
			x = 0.1;
			y = 0.2;
			w = 0.8;
			h = (1 / 25);
		...
		class ButtonAddG : VAS_RscButtonMenu
		{
			...
			text = "Add Item";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] execVM 'INS_revive\gear\add.sqf'";
		...
		class ButtonRemoveG : VAS_RscButtonMenu
		{
			...
			text = "Remove Item";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] execVM 'INS_revive\gear\remove.sqf'";
...
class VAS_Load_Diag {
	...
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[1] execVM 'INS_revive\gear\refresh.sqf'";
	...
	class controls {
		...
		class LoadLoadoutList : VAS_RscListBox 
		{
			...
			text = "";
			sizeEx = 0.035;
			onLBSelChanged = "[1] execVM 'INS_revive\gear\csel.sqf'";
...
class VAS_Save_Diag {
	...
	movingEnable = false;
	enableSimulation = true;
	onLoad = "[0] execVM 'INS_revive\gear\refresh.sqf'";
	...
	class controls {
		...
		class SaveLoadoutList : VAS_RscListBox 
		{
			...
			text = "";
			sizeEx = 0.035;
			onLBSelChanged = "[0] execVM 'INS_revive\gear\csel.sqf'";
		...
		class GearSaveMenu : VAS_RscButtonMenu {
			...
			text = "Save";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			onButtonClick = "[] call fnc_save_gear; [0] execVM 'INS_revive\gear\csel.sqf';";
